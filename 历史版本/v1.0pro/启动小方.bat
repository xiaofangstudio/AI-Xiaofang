...
rem ============================================================
chcp 65001 >nul
title Xiaofang FlphaLit 1.0 Pro launcher
setlocal

echo.
echo  ================================================
echo    Xiaofang FlphaLit 1.0 Pro - env check and launch
echo  ================================================
echo.
...
:RUNX
rem ---------- 4. run Xiaofang ----------
echo  [OK] Everything ready. Launching Xiaofang FlphaLit 1.0 Pro ...
echo.
cd /d "%~dp0"
%PY% "xiaofang_v10pro.py"
echo.
