...
import xiaofang_data_v06alpha as DATA


VERSION = "0.6 Alpha"
ENGINE_NAME = "FangAlpha"
MODEL_NAME = "AI 小方 FangAlpha 0.6 Alpha"
STUDIO_NAME = "小方工作室"
...
def _auto_dims():
    ...
    if budget >= 5:
        d, L, H = 1280, 14, 16      # 8GB+ 独显 / 大内存
    elif budget >= 3:
        d, L, H = 1152, 12, 16      # 中高配
    elif budget >= 1.5:
        d, L, H = 896, 12, 14       # 中配
    else:
        d, L, H = 768, 10, 12       # 低配兜底, 保证轻量可跑
