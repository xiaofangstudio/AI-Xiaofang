...
class DeepThinkTransformer:
    def __init__(self, vocab_list, d_model=256, n_layers=4, n_heads=8,
...
class XiaoFang:
    def __init__(self):
        ...
        self.transformer = DeepThinkTransformer(
            vocab_list, d_model=256, n_layers=4, n_heads=8, ngram_lm=self.lm)
    ...
    def handle_command(self, cmd):
        ...
        if c == "/help":
            ...
            print(C_REPLY + "💡 4层×8头·d_model=256 | Token计量 | 50条上下文 | 联网整合 | 矩阵运算可视化" + C_RESET)
            return "ok"
        elif c == "/clear":
            self.history.clear()
            self.meter.reset()
