@echo off
rem ============================================================
rem   Xiaofang FlphaLit 1.2 launcher (archived version)
rem   ASCII-safe (no non-ASCII bytes) + chcp 65001 + goto-flow
rem   so cmd never flash-closes. Run this .bat in this folder.
rem ============================================================
chcp 65001 >nul
title Xiaofang FlphaLit 1.2 launcher
setlocal

echo.
echo  ================================================
echo    Xiaofang FlphaLit 1.2 - env check and launch
echo  ================================================
echo.
...
echo.
rem ---------- run ----------
echo  [OK] Launching Xiaofang FlphaLit 1.2 ...
echo.
cd /d "%~dp0"
%PY% "xiaofang_v12.py"
echo.
