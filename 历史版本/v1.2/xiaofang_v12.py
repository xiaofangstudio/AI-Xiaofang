...
import xiaofang_data_v12 as DATA


VERSION = "1.2"
ENGINE_NAME = "FlphaLit"
MODEL_NAME = "AI 小方 FlphaLit 1.2"
STUDIO_NAME = "小方工作室"
...
# ============================================================
class LearnerMemory:
    MEM_FILE = "xiaofang_memory_v12.json"
    _LEGACY_FILES = ("xiaofang_memory_v11pro.json",
...
class XiaoFang:
    ...
    def run(self):
        ...
        def _reader():
            while True:
                try:
                    line = input(C_REPLY + "你: " + C_RESET).strip()
                except (EOFError, KeyboardInterrupt):
                    mailbox.append(None)
                    return
                mailbox.append(line)
