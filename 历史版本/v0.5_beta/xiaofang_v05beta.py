...
import xiaofang_data_v05beta as DATA


VERSION = "0.5 Beta"
ENGINE_NAME = "Flphalit"
MODEL_NAME = "AI 小方 Flphalit 0.5 Beta"
STUDIO_NAME = "小方工作室"
...
# ============================================================
# v0.5 Beta: 数学求解器 (纯原生, 递归下降解析, 不做字符串 eval)
# ============================================================
class _MathParser:
    def __init__(self, s):
...
class XiaoFang:
    ...
    def search_and_integrate(self, query, emo):
        ...
        # v0.5 Beta: 自升级大脑——从抓到的网页内容里学生词/生解释
        learn_extra = ""
        try:
    ...
    def process_chat(self, user_input):
        ...
        # v0.5 Beta: 自升级大脑——从用户这句里学生词/学的解释
        learn_note = ""
        if text:
