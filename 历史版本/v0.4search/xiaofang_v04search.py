...
import xiaofang_data_v04search as DATA


VERSION = "0.4 Search"
ENGINE_NAME = "Flphalit"
MODEL_NAME = "AI 小方 Flphalit 0.4 Search"
STUDIO_NAME = "小方工作室"
STUDIO_SITE = "fanggame.company"
SEARCH_BACKENDS = ["duckduckgo", "bing", "brave", "google", "auto"]  # v0.4Search 多后端联网

# v0.4Search: 模型规模常量 (2048 维 · 多头中深多重运算)
MODEL_D = 2048
MODEL_LAYERS = 12
MODEL_HEADS = 16
