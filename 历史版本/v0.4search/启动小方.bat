...
rem ============================================================
chcp 65001 >nul
title Xiaofang V0.4Search launcher
setlocal

echo.
echo  ============================================
echo    Xiaofang V0.4Search launcher
echo  ============================================
echo.
...
%PY% --version 2>nul
echo.
echo  Loading Xiaofang V0.4Search, building model - please wait (~15-40 sec) ...
echo.
cd /d "%~dp0"
%PY% "xiaofang_v04search.py"
echo.
echo  [Program exited]
pause
endlocal