...
import xiaofang_data_v07 as DATA


VERSION = "0.7"
ENGINE_NAME = "FangPro"
MODEL_NAME = "AI 小方 FangPro 0.7"
STUDIO_NAME = "小方工作室"
...
def _auto_dims():
    ...
    # v0.6 正式版: 维度上调逼近 GPT-1(768d)之上, 让思考更充分; 8GB 独显(预算≈4.8)即上 1408×16
    if budget >= 4.5:
...
# ============================================================
# v0.7: 自学习记忆 (Persistent Self-Learning)
...
# ============================================================
class LearnerMemory:
    MEM_FILE = "xiaofang_memory_v07.json"
    ...
    def _mem_path(self):
        return os.path.join(os.path.dirname(os.path.abspath(__file__)), self.MEM_FILE)
    ...
    def _save(self):
        p = self._mem_path()
        try:
            data = {"version": "0.7", "seq": self._seq,
...
class XiaoFang:
    ...
    def handle_command(self, cmd):
        ...
        if c == "/help":
            ...
            print(C_REPLY + "🧠 v0.7: 学到的新词与释义会本地持久化, 退出/重进/清上下文都在; 只存学习成果, 不存对话与人格; 有上限+遗忘机制。" + C_RESET)
