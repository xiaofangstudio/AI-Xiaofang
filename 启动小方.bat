@echo off
rem ============================================================
rem   Xiaofang FlphaLit 1.4 Alpha launcher
...
rem ============================================================
chcp 65001 >nul
title Xiaofang FlphaLit 1.4 Alpha launcher
setlocal

echo.
echo  ================================================
echo    Xiaofang FlphaLit 1.4 Alpha - env check and launch
echo  ================================================
echo.
...
:RUNX
rem ---------- 4. run Xiaofang ----------
echo  [OK] Everything ready. Launching Xiaofang FlphaLit 1.4 Alpha ...
echo.
cd /d "%~dp0"
%PY% "xiaofang_v14alpha.py"
echo.
